...
public class creditlnquiry {
    ...
    private menuOption choices[] = {
        menuOption.zero_balance, menuOption.credito_balance, 
        menuOption.debito_balance, menuOption.end};
    ...
    private menuOption getRequest() {
        ...
        System.out.printf("\n%s\n%s\n%s\n%s\n%s\n", 
        "Enter request", "1 - Lista contas com zero", "2 - Lista contas com credito", 
